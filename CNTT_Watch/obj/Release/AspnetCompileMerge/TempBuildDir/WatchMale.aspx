<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="WatchMale.aspx.cs" Inherits="CNTT_Watch.WatchMale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br /><br /><h2><span>ĐỒNG HỒ NAM</span></h2><br />
    <asp:DataList ID="dlWatchMale" RepeatColumns="4" runat="server">
        <ItemTemplate>
