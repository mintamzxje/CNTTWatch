<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="WatchFemale.aspx.cs" Inherits="CNTT_Watch.WatchFemale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br /><br /><h2><span>ĐỒNG HỒ NỮ</span></h2><br />
    <asp:DataList ID="dlWatchFemale" RepeatColumns="4" runat="server">
        <ItemTemplate>
